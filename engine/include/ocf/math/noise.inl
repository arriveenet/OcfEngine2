    ...
    T result = detail::lerp(
        ...
        detail::lerp(v_fade,
                     ...
                     detail::lerp(u, detail::grad(detail::p[AB], x, y - static_cast<T>(1), z),
                                  detail::grad(detail::p[BB], x - static_cast<T>(1),
                                               y - static_cast<T>(1), z))),
        detail::lerp(v_fade,
                     detail::lerp(u, detail::grad(detail::p[AA + 1], x, y, z - static_cast<T>(1)),
                                  detail::grad(detail::p[BA + 1], x - static_cast<T>(1), y,
                                               z - static_cast<T>(1))),
                     detail::lerp(u,
                                  detail::grad(detail::p[AB + 1], x, y - static_cast<T>(1),
                                               z - static_cast<T>(1)),
                                  detail::grad(detail::p[BB + 1], x - static_cast<T>(1),
                                               y - static_cast<T>(1), z - static_cast<T>(1)))));
    ...
    T result = detail::lerp(
        ...
        detail::lerp(
            ...
            detail::lerp(v_fade,
                         ...
                         detail::lerp(u,
                                      detail::grad(detail::p[ABA], x, y - static_cast<T>(1), z, w),
                                      detail::grad(detail::p[BBA], x - static_cast<T>(1),
                                                   y - static_cast<T>(1), z, w))),
            detail::lerp(
                v_fade,
                detail::lerp(u, detail::grad(detail::p[AAB], x, y, z - static_cast<T>(1), w),
                             detail::grad(detail::p[BAB], x - static_cast<T>(1), y,
                                          z - static_cast<T>(1), w)),
                detail::lerp(u,
                             detail::grad(detail::p[ABB], x, y - static_cast<T>(1),
                                          z - static_cast<T>(1), w),
                             detail::grad(detail::p[BBB], x - static_cast<T>(1),
                                          y - static_cast<T>(1), z - static_cast<T>(1), w)))),
        detail::lerp(
            s,
            detail::lerp(
                v_fade,
                detail::lerp(u, detail::grad(detail::p[AAA + 1], x, y, z, w - static_cast<T>(1)),
                             detail::grad(detail::p[BAA + 1], x - static_cast<T>(1), y, z,
                                          w - static_cast<T>(1))),
                detail::lerp(u,
                             detail::grad(detail::p[ABA + 1], x, y - static_cast<T>(1), z,
                                          w - static_cast<T>(1)),
                             detail::grad(detail::p[BBA + 1], x - static_cast<T>(1),
                                          y - static_cast<T>(1), z, w - static_cast<T>(1)))),
            detail::lerp(v_fade,
                         detail::lerp(u,
                                      detail::grad(detail::p[AAB + 1], x, y, z - static_cast<T>(1),
                                                   w - static_cast<T>(1)),
                                      detail::grad(detail::p[BAB + 1], x - static_cast<T>(1), y,
                                                   z - static_cast<T>(1), w - static_cast<T>(1))),
                         detail::lerp(u,
                                      detail::grad(detail::p[ABB + 1], x, y - static_cast<T>(1),
                                                   z - static_cast<T>(1), w - static_cast<T>(1)),
                                      detail::grad(detail::p[BBB + 1], x - static_cast<T>(1),
                                                   y - static_cast<T>(1), z - static_cast<T>(1),
                                                   w - static_cast<T>(1))))));
